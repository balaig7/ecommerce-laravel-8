...
<html>
    <head>
        ...
        <link href="{{asset('css/admin/responsive.bootstrap.min.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{asset('css/admin/dataTables.bootstrap.min.css')}}" rel="stylesheet" type="text/css"/>
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="index.html" class="logo"><img src="{{asset('admin/images/logo_white_2.png')}}" height="28"></a>
                        <a href="index.html" class="logo-sm"><img src="{{asset('admin/images/logo_sm.png')}}" height="36"></a>
                    </div>
                </div>
